...
def get_time_slots(selected_date):
    ...
    slots.append(InlineKeyboardButton("✏️ Указать время вручную", callback_data="time_manual"))
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Как создать поездку нажмите - /info\n\n"
...
def build_message(ride: dict) -> str:
    ...
    msg += "Оставьте ваше предложение здесь - @poputchik_asino_bot"
    return msg
